...
test('match-list should display matches which marked in checkboxes', async () => {
	...
	fireEvent.click(within(queryAllByTestId('team-checkbox')[0]).queryByRole('checkbox'));
	fireEvent.click(within(queryAllByTestId('team-checkbox')[1]).queryByRole('checkbox'));
	expect(queryAllByTestId('match')).toHaveLength(1);
	fireEvent.click(within(queryAllByTestId('team-checkbox')[2]).queryByRole('checkbox'));
	fireEvent.click(within(queryAllByTestId('team-checkbox')[3]).queryByRole('checkbox'));
