...
test('Test of teams names displaying', () => {
...
test('Test of date and time displaying', () => {
    render(<Match {...props}></Match>);

    let dateStr = date.toLocaleDateString('ru', {month:'long',day:'numeric'});
    let timeStr = date.toLocaleTimeString('ru', {hour:'numeric',minute:'numeric'});
...
describe('Test labels', () => {
    test('Test schedeled after week, no labels', () => {
...
test('Test of logotypes displaying', () => {
    render(<Match {...props}></Match>);
